...
class SomniaLegacyWeb3Service {
  static final SomniaLegacyWeb3Service _instance = SomniaLegacyWeb3Service._internal();
  factory SomniaLegacyWeb3Service() => _instance;
  SomniaLegacyWeb3Service._internal();
  ...
  void initialize([String network = ContractsConfig.defaultNetwork]) {
    ...
    print('🎯 SomniaLegacyWeb3Service: Initialized with Somnia Testnet contracts (Legacy Gas):');
  ...
  // Create event on blockchain using LEGACY GAS for Somnia Testnet
  Future<String> createEvent({
    ...
    try {
      print('🎯 SomniaLegacyWeb3Service: Creating event on Somnia Testnet (Legacy Gas)...');
      print('📝 Event Details:');
      ...
      // Create the transaction with LEGACY GAS for Somnia Testnet
      ...
      print('🔗 Sending transaction to wallet for signing (Legacy Gas)...');
      ...
      print('✅ SomniaLegacyWeb3Service: Event creation transaction sent successfully');
      print('📝 Transaction Hash: $txHash');
      print('🔗 View on explorer: https://shannon-explorer.somnia.network/tx/$txHash');

      return txHash;
    } catch (e) {
      print('❌ SomniaLegacyWeb3Service: Error creating event: $e');
  ...
  Future<TransactionReceipt?> waitForTransactionConfirmation(String txHash) async {
    try {
      print('⏳ SomniaLegacyWeb3Service: Waiting for transaction confirmation...');
      print('📝 Transaction Hash: $txHash');
      ...
      while (receipt == null && attempts < maxAttempts) {
        ...
        try {
          ...
          if (receipt != null) {
            print('✅ SomniaLegacyWeb3Service: Transaction confirmed!');
          ...
          if (attempts % 10 == 0) { // Log every 10 seconds
            print('⏳ SomniaLegacyWeb3Service: Still waiting for confirmation... (${attempts + 1}s)');
          }
        }
        attempts++;
      }
      ...
      if (receipt == null) {
        print('⚠️ SomniaLegacyWeb3Service: Transaction confirmation timeout after ${maxAttempts} seconds');
      ...
      print('❌ SomniaLegacyWeb3Service: Error waiting for transaction confirmation: $e');
      rethrow;
    }
  }
  ...
  Map<String, dynamic> getNetworkInfo() {
    return {
      'name': 'Somnia Testnet (Legacy Gas)',
      'chainId': _chainId,
      'rpcUrl': _rpcUrl,
